...
const Layout = ({ children }) => {
  ...
  return (
    <>
      <Head>
        <title>Dinder | Swipe Bite</title>
        <meta
          name="title"
          content="Dinder, it's what's for dinner."
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="min-h-screen flex flex-col">
        <header className="h-16 w-full shadow-md bg-transparent">
            ...
            <div className="h-full px-4 flex justify-between items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="hidden sm:block bg-gray-200 hover:bg-rose-500 transition px-3 py-1 rounded-md">
                    Start a meal
                  </button>
                {isLoadingUser ? (
