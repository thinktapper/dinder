                ...
                <div className="px-4 sm:px-12">
                  <div className="flex justify-center">
                    <Link href="/">
                      <a className="flex items-center space-x-1">
                        {/* <FireIcon className="shrink-0 w-8 h-8 text-rose-500" />
                        <span className="text-xl font-semibold tracking-wide">
                          Din<span className="text-rose-500">der</span>
                        </span> */}
                        <Image src={'/dinder-flame-black.svg'} alt='Dinder Logo' width={155} height={45} />
                      </a>
                    </Link>
                  </div>
                  ...
                  {!showSignIn ? (
                    <Dialog.Description className="mt-2 text-gray-500 text-base text-center">
                      Please create an account to find restaurants and bookmark
                      your favorite ones.
                    </Dialog.Description>
                  ) : null}
